...
// 0001–0009 (journal v1 + advisor fixes + The Black Road import, which
...
// gear, rest_character). Do not hand-edit — regenerate after any
// schema change and commit the diff alongside the migration that
// caused it, per CLAUDE.md's "never let schema and migrations drift"
// rule.
