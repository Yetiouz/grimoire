...
// 0001–0005 (journal v1 + advisor fixes + The Black Road import, which
// added characters/npcs/factions/quests/treasure + per-character color).
// Do not hand-edit — regenerate after any schema change and commit the
// diff alongside the migration that caused it, per CLAUDE.md's "never
// let schema and migrations drift" rule.
